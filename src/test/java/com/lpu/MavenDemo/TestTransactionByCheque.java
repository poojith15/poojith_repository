...
public class TestTransactionByCheque {
	...
	@DisplayName("Validaton for the account ID Format")
	@Test
	...
	public void Test6() throws AccountIdException {
		Cheque cheque = new Cheque("100010989565", LocalDate.now());
		assertThrows(AccountIdException.class, () -> ser.doTransaction(cheque, "Debit", 50.0));
	}
