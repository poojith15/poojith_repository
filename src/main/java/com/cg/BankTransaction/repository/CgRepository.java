package com.cg.BankTransaction.repository;
...
import com.cg.BankTransaction.entity.Address;
import com.cg.BankTransaction.entity.Branch;
...
public class CgRepository {
	...
	static{
		...
		Address add1=new Address("H No.12/9","2nd line","Amaravathi Nagar","KURNOOL","ANDHRA PRADESH","INDIA","523110",branch1);
		Address add2=new Address("H No.14/6","3rd line","Amar Nagar","SRIKAKULAM","ANDHRA PRADESH","INDIA","523101",branch2);
		Address add3=new Address("H No.356/5","1st line","Jyothi market","GUNTUR","ANDHRA PRADESH","INDIA","510110",branch3);
		Address add4=new Address("H No.23/1","4th line","Maruthi Nagar","TIRUPATHI","ANDHRA PRADESH","INDIA","532008",branch4);
		...
		Customer cust1=new Customer("ct0001001", "Rao Ramesh", add1 , "121156982034", "XVGY258945", "9638521472" , "MALE" , date1);
		Customer cust2=new Customer("ct0001552", "Babu Suresh", add2 , "125153315555", "FBTN651513", "9513563153" , "MALE" , date1);
		Customer cust3=new Customer("ct0005133", "Amma Kumar", add3 , "121211112546", "KJJK321543", "8984653165" , "MALE" , date1);
		Customer cust4=new Customer("ct0008946", "Manasa Reddy", add4 , "115511552165", "RTHF655588", "9865316645" , "FEMALE" , date1);
        ...
        AccTransaction tran1=new AccTransaction("100000123456","Credit",5515.0,"slip",date5,"-","Rao Ramesh","self",200065.26);
        AccTransaction tran2=new AccTransaction("100000989565","Debit",89515.0,"slip",date5,"-","Babu Suresh","self",305067.86);
        AccTransaction tran3=new AccTransaction("100000248465","Debiit",95615.0,"slip",date5,"-","Amma Kumar","self",500895.59);
