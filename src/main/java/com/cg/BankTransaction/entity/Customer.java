...
public class Customer {
	...
	public String toString() {
		return "Customer Id:"+customerId+"Customer Name:"+customerName+customerAddress
				+"Customer Aadhar:"+customerAadhar+"Customaer Pan:"+customaerPan
				+"Customaer Contact:"+customaerContact+"Customaer Gender:"+customaerGender
				+"Customaer Date of birth:"+customaerDob;
	}
