...
import com.lpu.MavenDemo.dao.TransactionDao;
import com.lpu.MavenDemo.dao.TransactionDaoImpl;
...
/**
 * 
 * @author poojith This class contains the methods of debit and credit
 *         transaction by slip and cheque.
 */
public class TransactionServiceImpl implements TransactionService {
	TransactionDao txDao = new TransactionDaoImpl();

	/**
	 * This method validates the received input.After they are properly validated,
	 * transaction will be completed (debit or credit).
	 * 
	 * @param accid
	 * @param txType
	 * @param amt
	 ...
	 * 
	 * @throws It throws AccountIdFormateException, TransactionTypeException,
	 *            AccountIdException and AmountException.
	 */
	@Override
	 ...
	 * @return boolean
	 * 
	 * @throws AccountIdFormateException, TransactionTypeException, AmountException
	 *                                    and AccountIdException
	 */
	@Override
